    ...
    return apiProducts.map((product) => {
      const mappedProduct = {
        ...
        Votes:
          ...
          0,
        Colors:
          product.colors || product.Colors || product.availableColors || [],
        sold:
          product.sold ||
          product.totalSold ||
          product.soldCount ||
          Math.floor(Math.random() * 2000) + 50, // Fallback với random number
        ...
        specifications:
          ...
          [],
        reviews:
          product.reviews || product.Reviews || product.customerReviews || [],
